...
const CLOUD_WORDBOOK_MAP = {
  ...
  junior_7th_ren_jiao_second_new: {
    path: 'wordbooks/junior_7th_ren_jiao_second_new_words.json',
    cloudFileID: `cloud://${CLOUD_ENV_ID}.${CLOUD_BUCKET}/wordbooks/junior_7th_ren_jiao_second_new_words.json`,
    version: 1,
    totalWords: 462
  },
  junior_8th_ren_jiao_new: {
    path: 'wordbooks/junior_8th_ren_jiao_new_words.json',
    cloudFileID: `cloud://${CLOUD_ENV_ID}.${CLOUD_BUCKET}/wordbooks/junior_8th_ren_jiao_new_words.json`,
    version: 1,
    totalWords: 551
  },
  junior_8th_ren_jiao_second_new: {
    path: 'wordbooks/junior_8th_ren_jiao_second_new_words.json',
  ...
  junior_9th_ren_jiao_full_new: {
    path: 'wordbooks/junior_9th_ren_jiao_full_new_words.json',
    cloudFileID: `cloud://${CLOUD_ENV_ID}.${CLOUD_BUCKET}/wordbooks/junior_9th_ren_jiao_full_new_words.json`,
    version: 1,
    totalWords: 604
  }
};
