...
function configuration(environment={}) {
  ...
  if(c.iosPreparationEnabled||c.iosPaymentEnabled)check(c.iosTeacher&&c.iosPlatformReady&&c.iosExpiresAt>0,'FORMAL_INVALID_IOS_GATE');
...
function iosBuyer(c,teacherId,now){return !!c.iosTeacher&&c.iosTeacher===teacherId&&c.iosPlatformReady&&now<c.iosExpiresAt;}
