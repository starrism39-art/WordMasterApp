...
const tests = [
  ...
  'test/learning-explicit-wordbook-route.test.js',
  ...
  'test/homepage-full-pull-event-coordination.test.js',
  'test/homepage-initial-lifecycle-refresh.test.js',
  ...
  'test/wordbook-switch-flow.test.js',
  'test/teacher-wordbook-disable.test.js',
  'test/teacher-wordbook-disable-page.test.js',
  ...
  'test/local-export-core.test.js',
